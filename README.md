...
beeins has two sides, switchable from the top-left tabs:

### 📇 Cards — vocabulary flashcards

- **4,600+ German words**, each with a real example sentence.
- **Study by level** — A1, A2, or B1. Levels are cumulative, so B1 includes everything below it.
...
English · Russian · Ukrainian · Vietnamese · Persian · Thai · Chinese · Malay · Turkish · Polish · Swahili · Amharic · Hindi · Urdu · Mexican Spanish · Catalan · Croatian · Serbian · Greek · and Egyptian, Lebanese & Syrian Arabic
...
- **Newcomers and immigrants** learning German who want explanations in their first language, not only in English.
