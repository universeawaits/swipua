...
// examples carry {tr,en,ru,de,ar_sy}; hints carry {en,ru,de,ar_sy} (contrastive, per study-from language).
// Generated by the turkish-grammar workflow, grounded in Yedi Iklim / Istanbul YIT / Yeni Hitit.
const GRAMMAR = [
 {
  "id": "vowel-harmony",
  "icon": "🔤",
  ...
  "intro": {
   ...
   "ru": "В турецком языке гласный в суффиксе подстраивается под последний гласный слова. Есть два правила: двухвариантная гармония (e/a) и четырёхвариантная (i/ı/u/ü). После заднего гласного идёт задний, после переднего — передний.",
  ...
  "hints": {
   ...
   "ru": "В русском окончания зависят от рода/падежа, но не от «задний/передний» гласный. В турецком выбор гласного в суффиксе диктует именно последний гласный слова. Внимание: ı и i, а также o/ö, u/ü — разные звуки, их нельзя путать.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком, когда к слову добавляется суффикс, начинающийся с гласной, конечный твёрдый согласный смягчается: p→b, ç→c, t→d, k→ğ. Кроме того, суффиксы -de/-te и -den/-tan начинаются с t после глухого согласного и с d в остальных случаях.",
  ...
  "hints": {
   ...
   "ru": "В русском конечные согласные оглушаются (дуб звучит как дуп); в турецком наоборот — глухой согласный озвончается перед гласной, и это отражается на письме. И не забывайте выбирать -te/-ten после глухого согласного.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком существительное ставится во множественное число прибавлением -lar или -ler в конце слова. Выбор зависит от последней гласной (гармония гласных): -lar после задней гласной, -ler после передней. После числительного суффикс множественного числа НЕ используется.",
  ...
  "hints": {
   ...
   "ru": "В отличие от русского, множественное число в турецком образуется одним регулярным суффиксом -lar/-ler без падежных и родовых изменений самого корня. Главное: после числительного и после 'çok' (много) существительное остаётся в единственном числе — 'üç kitap' (три книга), а не 'üç kitaplar'.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Личные местоимения: ben, sen, o, biz, siz, onlar. Они принимают падежные окончания в зависимости от роли в предложении (beni, bana, bende…). Формы \"bana\" и \"sana\" неправильные.",
  ...
  "hints": {
   ...
   "ru": "В турецком роль местоимения показывают падежные окончания (beni, bana, bende…), а не предлоги, как в русском. Запомните неправильные формы \"bana\" и \"sana\" (а не \"bene/sene\"). Местоимение-подлежащее часто опускается, ведь лицо видно по окончанию глагола.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком «быть» — не отдельное слово, а личное окончание, которое присоединяется к концу слова и меняется по гармонии гласных. Отрицание образуется словом «değil», вопрос — частицей «-mı/-mi». Чтобы сказать, что что-то есть или нет, используют «var» и «yok».",
  ...
  "hints": {
   ...
   "ru": "В русском связка «быть» в настоящем времени опускается, а в турецком нужно добавлять личное окончание (кроме часто опускаемого 3-го лица). Отрицание — отдельное слово «değil» после прилагательного, а «есть/нет» передаются словами «var/yok», которые ставятся в конце предложения.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Суффикс -(ı)yor выражает действие, происходящее прямо сейчас (\"я делаю сейчас\"), а также общие и привычные действия. Он присоединяется к основе глагола: после гласной просто -yor, после согласной вставляется соединительная гласная ı/i/u/ü (yap-ı-yor, gel-i-yor). Затем идёт личное окончание.",
  ...
  "hints": {
   ...
   "ru": "Одно и то же время выражает и \"я читаю сейчас\", и \"я читаю (обычно)\" — в турецком нет отдельного вида, как в русском совершенный/несовершенный здесь не важен. Помните про гармонию гласных в соединительной гласной (yapıyor, geliyor, okuyor, görüyor).",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Вместо отдельного слова «мой, твой, его» турецкий добавляет аффикс к существительному: evim (мой дом), evin (твой дом), evi (его дом). Гласная аффикса подчиняется гармонии. Чтобы указать владельца, к нему добавляется -in, а к предмету — притяжательный аффикс: Ali'nin evi (дом Али).",
  ...
  "hints": {
   ...
   "ru": "В отличие от русского, здесь нет отдельного слова «мой/твой» — притяжательность выражается аффиксом на самом предмете. И запомните двойную маркировку: у владельца -in (Ali'nin), а у предмета свой аффикс (evi) — как будто «Али-его дом».",
 ...
 },
 {
  ...
  "title": {
   ...
   "ru": "Прошедшее очевидное время -dı",
  ...
  "intro": {
   ...
   "ru": "Очевидное прошедшее время используется для завершённых действий, которые говорящий сам видел, пережил или точно знает. Суффикс присоединяется к основе глагола по гармонии гласных: -dı/-di/-du/-dü, а после глухого согласного (ç, f, h, k, p, s, ş, t) — -tı/-ti/-tu/-tü.",
  ...
  "hints": {
   ...
   "ru": "Русскому не нужно выбирать род: -dı одинаково для он/она/оно (o geldi). Зато суффикс меняется по гармонии гласных (geldim/aldım) и оглушается после глухих (gitti, а не *gitdi) — этого в русском нет. Местоимение обычно опускается.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Чтобы задать вопрос «да/нет», в турецком добавляется отдельно пишущаяся частица mı/mi/mu/mü. Она согласуется с последней гласной предыдущего слова и обычно стоит сразу после слова, о котором спрашивают. Личные окончания присоединяются к самой частице.",
  ...
  "hints": {
   ...
   "ru": "В отличие от русского, где вопрос часто передаётся только интонацией, турецкий требует частицу. Она похожа на «ли», но её гласная меняется (mı/mi/mu/mü), пишется отдельно, и личные окончания присоединяются именно к ней (misin, miyim).",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком отрицание образуется тремя способами: суффиксом -ma/-me у глаголов, словом değil с существительными и прилагательными и словом yok для отсутствия. Выбор зависит от сказуемого.",
  ...
  "hints": {
   ...
   "ru": "В русском одно «не/нет», а в турецком три разных средства: суффикс -ma/-me внутри глагола, değil для имён и прилагательных, и yok для отсутствия. Не переносите одно «нет» на все случаи. И помните: перед настоящим временем -yor суффикс -ma/-me превращается в -mı/-mi (gitmiyor, а не gitmayor).",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Падежи в турецком — это окончания, которые присоединяются к существительному и показывают его роль в предложении. Винительный, дательный, местный, исходный и родительный падежи прибавляются к слову и меняются по закону гармонии гласных. Если слово оканчивается на гласную, вставляется соединительная буква -y- (винительный, дательный) или -n- (родительный).",
  ...
  "hints": {
   ...
   "ru": "В русском падежи тоже есть, но окончания слитные и нерегулярные; в турецком каждое значение — один чёткий суффикс, подчиняющийся гармонии гласных. Важно: винительный суффикс ставится только у определённого объекта (\"эту книгу\"), а неопределённый объект идёт без окончания.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Настоящее-будущее время (аорист) выражает привычки, общие истины и готовность или предложение. К основе глагола добавляется -(a/ı)r; отрицание неправильное (-maz/-mez, но -mam/-mem для «я»).",
  ...
  "hints": {
   ...
   "ru": "В русском нет отдельной формы: аорист передаётся настоящим временем для привычек и общих истин, но также выражает готовность и предложение («выпьешь чаю?»). Осторожно с неправильным отрицанием 1-го лица: gelmem, içmem, а не gelmezim.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "-mış используется для событий, которые ты сам не видел: услышал от кого-то, вывел по признакам, заметил задним числом или удивился. В отличие от очевидного прошедшего (-dı), оно показывает, что тебя там не было: «говорят», «оказывается», «судя по всему».",
  ...
  "hints": {
   ...
   "ru": "В русском нет глагольного показателя пересказа: -mış передаёт «говорят», «оказывается», «наверное» и удивление одним окончанием, где ты бы добавил вводное слово. Учти четыре варианта гласной суффикса и то, что в 3-м лице ед. ч. личного окончания нет.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Будущее время описывает действия, которые произойдут позже. К глаголу добавляется -ecek или -acak по гармонии гласных; после гласной вставляется -y- (bekleyecek). Перед гласным окончанием конечный k смягчается в ğ: geleceğim.",
  ...
  "hints": {
   ...
   "ru": "В турецком одно окончание будущего -(y)ecek/-(y)acak по гармонии гласных, и нет разницы вида (сделаю / буду делать) — одна форма. Помните смягчение k→ğ перед гласной: geleceğim, а не 'gelecekim'.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Послелог ставится ПОСЛЕ существительного или местоимения. Одни (ile, için, gibi, kadar) требуют слово в исходной (нулевой) форме, другие — падеж: sonra/önce берут исходный падеж (-den), а kadar в значении «до» — дательный (-e). С местоимениями ile/için/gibi используют родительную форму: benimle, benim için, benim gibi.",
  ...
  "hints": {
   ...
   "ru": "Послелоги стоят ПОСЛЕ слова, а не перед ним, как русские предлоги. sonra/önce требуют исходного падежа (-den): dersten sonra. ile часто присоединяется как -le/-la (arkadaşımla). С местоимениями ile/için/gibi берут родительную форму: benimle, benim için — не «*ben için».",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком само прилагательное не меняется. Daha значит «более», en — «самый». То, с чем сравнивают, ставится в исходном падеже -dan/-den (benden uzun — выше меня), а равенство выражается словом kadar (benim kadar — такой же, как я).",
  ...
  "hints": {
   ...
   "ru": "В русском «чем» — отдельное слово, а сравнение часто идёт с родительным падежом; в турецком к предмету сравнения добавляется исходный падеж -dan/-den, и он стоит перед прилагательным. При исходном падеже слово daha можно опустить.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком повелительное наклонение побуждает к действию: gel — приходи (ты), gelin — приходите (вы), gelsin — пусть придёт. Желательное наклонение -eyim / -elim выражает предложение или намерение для «я/мы»: gideyim — давай я пойду, gidelim — давай(те) пойдём.",
  ...
  "hints": {
   ...
   "ru": "Русский различает ты/вы в повелении, но в турецком есть ещё форма 3-го лица (gelsin = «пусть придёт»), которой в русском соответствует конструкция с «пусть». Формы -eyim / -elim передают «давай(те)», а не отдельное местоимение.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "-abil/-ebil выражает, что мы можем что-то сделать или что это возможно; его отрицание — особая форма -ama/-eme (gelemem). -meli/-malı показывает, что мы должны или обязаны что-то сделать (gitmeliyim).",
  ...
  "examples": [
   ...
   },
   {
    ...
    "ru": "Ты должен много заниматься для экзамена.",
  ...
  "hints": {
   ...
   "ru": "В русском способность выражается отдельными словами (мочь/уметь), а долженствование — «должен». В турецком и то, и другое встроено в глагол как окончание, а отрицание «не могу» имеет особую форму, не совпадающую с обычным отрицанием.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Условный аффикс -se/-sa присоединяется к глаголу и означает «если». Для реальных, возможных условий он сочетается с настоящим-широким временем и даёт -irse/-arsa. В начале можно добавить слово eğer («если»), но так как значение уже несёт аффикс, eğer необязательно.",
  ...
  "hints": {
   ...
   "ru": "В русском «если» и «бы» — отдельные слова; в турецком условие встроено в окончание глагола, а eğer необязательно. Реальное условие («если позвонишь») — форма -irse; желание или нереальное условие («вот бы», «если бы») — чистое -se/-sa.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "Деепричастия соединяют два предложения при одном главном глаголе без союза, выражая время или образ действия. -ken — «пока/во время», -ince — «когда/как только», -erek/-arak — «делая/путём», -ip — «и (затем)». Оборот всегда стоит перед главным глаголом.",
  ...
  "hints": {
   ...
   "ru": "Русские деепричастия (улыбаясь, придя) хорошо соответствуют -erek/-arak и -ip, но у -ince и особенно -ken прямого одиночного аналога нет — их часто передают придаточным с «когда/пока». Помните: -erek/-arak и -ip требуют одного и того же подлежащего, а союз в турецком не нужен — значение уже в суффиксе.",
 ...
 },
 {
  ...
  "intro": {
   ...
   "ru": "В турецком нет относительного местоимения вроде «который»: вместо него к глаголу добавляют суффикс и ставят его перед существительным. Если существительное само выполняет действие (подлежащее), используют -en/-an (okuyan adam); если оно является дополнением — -dik или -ecek с притяжательным суффиксом (okuduğum kitap, okuyacağım kitap).",
  ...
  "hints": {
   ...
   "ru": "В русском есть слово «который» и оно склоняется; в турецком относительного местоимения нет вообще, а причастие ставится ПЕРЕД существительным. Различайте роль: -en/-an — для деятеля (подлежащее), -dik/-ecek с притяжательным суффиксом — для дополнения; лицо («кто сделал») выражается окончанием -um/-un/-u, а не отдельным местоимением.",
